...
function navigationMenu() {
	...
	trigger.addEventListener(eventtype, (e) => {
		if (classie.has(trigger, 'active')) {
			...
			TweenLite.to(nav, 0.3, { x: '0%', autoAlpha: 1 });
		}
...
const browserName = navigator.sayswho.toLowerCase();
...
export { decodeHtmlEntity, isEncoded, mobilecheck, getOrientation, getUrlVars, readCookie};
