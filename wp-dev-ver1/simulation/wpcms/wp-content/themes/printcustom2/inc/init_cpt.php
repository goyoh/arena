...
/* taxonomy => mark-direction */
function register_mark_direction_to_post_taxonomy() {
    $defaults = array(
      'slug' => 'mark-direction',
      'display' => 'マークの向き',
    );
...
add_action('init', 'register_mark_direction_to_post_taxonomy', 10, 2);
...
/* taxonomy => mark-ecolor */
function register_mark_ecolor_to_post_taxonomy() {
    $defaults = array(
      'slug' => 'mark-ecolor',
      'display' => 'マークのフチ色',
    );
...
add_action('init', 'register_mark_ecolor_to_post_taxonomy', 10, 2);
