...
function add_theme_scripts_stylesheet() {
  global $wp_scripts, $wp_styles, $post_type, $is_IE, $is_iphone;
    ...
    if ( !is_admin() ):
       ...
       */
      wp_register_style('style', network_site_url(). '/style-printc2.css', false, null, 'all');
    ...
    if(!is_admin()):
       ...
       * 
       */
      wp_register_script('modernizr', network_site_url() . '/assets/js/vendor/modernizr.js', false, NULL, true);
      ...
      wp_register_script('theme_scripts', network_site_url() . 'assets/js/printCustom2.js', false, null, true);
