...
<div class="mark-colour">
  <div class="mark-colour__section">
    ...
    <?php foreach((array)$colors as $key => $value): $code = $value->description; ?>
      <li class="mark-colour__item colour--<?php echo mb_strtolower($code); ?> <?php echo ($code == $init_col)? 'active' : ''; ?>" data-colour="#<?php echo $value->slug; ?>" data-code="<?php echo $code; ?>" style="background-color:#<?php echo $value->slug; ?>"></li>
    <?php endforeach; ?>
    </ul>
  </div>
</div>
